                ...
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3, lg: 4 }}>
                    {basketItems.map((product) => (
                        <Grid item xs={3} style={{ padding: 20 }}>
                            <Card sx={{ maxWidth: 345 }} style={{ height: '100%', border: "1px solid gray ", padding: 10 }}>
                                <CardMedia
                                    component="img"
                                    alt="green iguana"
                                    height="150px"
                                ...
                                />
                                <CardContent>
                                    <Typography gutterBottom variant="h6" component="div" style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",fontSize:18  }}>
                                        {product.title}
                                    </Typography>
